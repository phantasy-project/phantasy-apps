...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/sm-icons/search.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/sm-icons/check-square-fill.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.show_checked_btn.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/sm-icons/all.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.show_all_btn.setIcon(icon3)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/sm-icons/file.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.uri_type_cbb.addItem(icon5, "")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/sm-icons/hyperlink.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.uri_type_cbb.addItem(icon6, "")
        ...
        Dialog.setTabOrder(self.uri_name_lineEdit, self.upload_btn)
        Dialog.setTabOrder(self.upload_btn, self.search_lineEdit)
