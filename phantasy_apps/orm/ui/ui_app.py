...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.orm_measurement.setGeometry(QtCore.QRect(0, 0, 1553, 973))
        ...
        self.daq_rate_sbox.setProperty("value", 5)
        ...
        self.daq_nshot_sbox.setMaximum(100)
        self.daq_nshot_sbox.setProperty("value", 10)
        ...
        self.gridLayout.addWidget(self.settings_history_treeView, 8, 0, 1, 2)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_15, 6, 1, 1, 1)
        ...
        self.eva_daq_rate_sbox.setProperty("value", 5)
        ...
        self.eva_daq_nshot_sbox.setMaximum(100)
        self.eva_daq_nshot_sbox.setProperty("value", 5)
        ...
        self.label_36 = QtWidgets.QLabel(self.orm_apply)
        ...
        self.horizontalLayout_11.addWidget(self.scaling_factor_lineEdit)
        self.label_38 = QtWidgets.QLabel(self.orm_apply)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred,
                                           QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(8)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_36.setText(_translate("MainWindow", "Scaling Settings"))
        self.scaling_factor_lineEdit.setText(_translate("MainWindow", "1.0"))
        self.label_38.setText(
            _translate("MainWindow",
                       "Scaling factor multiplied onto corrector settings"))
        self.operations_toolBox.setItemText(
