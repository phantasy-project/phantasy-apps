...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.va_listWidget = QtWidgets.QListWidget(self.layoutWidget)
        self.va_listWidget.setMinimumSize(QtCore.QSize(150, 0))
        font = QtGui.QFont()
        ...
        self.delete_btn = QtWidgets.QToolButton(self.layoutWidget)
        icon2 = QtGui.QIcon()
