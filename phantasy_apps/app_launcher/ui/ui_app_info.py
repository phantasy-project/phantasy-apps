...
class Ui_InfoForm(object):
    def setupUi(self, InfoForm):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/close.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        ...
        self.toolButton.clicked.connect(InfoForm.on_close)
    ...
    def retranslateUi(self, InfoForm):
        ...
        self.toolButton.setText(_translate("InfoForm", "..."))
