...
class Ui_AppForm(object):
    ...
    def setupUi(self, AppForm):
        ...
        self.frame = QtWidgets.QFrame(self.app_btn_widget)
        ...
        self.app_btn = QtWidgets.QPushButton(self.frame)
        ...
        self.app_btn.setMinimumSize(QtCore.QSize(100, 100))
        self.app_btn.setMaximumSize(QtCore.QSize(100, 100))
        self.app_btn.setBaseSize(QtCore.QSize(100, 100))
        ...
        self.gridLayout.addWidget(self.app_btn, 0, 0, 1, 1)
        ...
        self.fav_btn.toggled['bool'].connect(
            AppForm.on_toggle_fav)  # type: ignore
        self.info_btn.toggled['bool'].connect(
            AppForm.on_toggle_info)  # type: ignore
