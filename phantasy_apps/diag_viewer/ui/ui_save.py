...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.pushButton_2.clicked.connect(Dialog.on_save_data)  # type: ignore
        self.browse_filepath_btn.clicked.connect(
            Dialog.on_get_filepath)  # type: ignore
        self.save_figure_chkbox.toggled['bool'].connect(
            self.label_3.setEnabled)  # type: ignore
        self.save_figure_chkbox.toggled['bool'].connect(
            self.figure_format_cbb.setEnabled)  # type: ignore
        self.save_figure_chkbox.toggled['bool'].connect(
            self.label_4.setEnabled)  # type: ignore
        self.save_figure_chkbox.toggled['bool'].connect(
            self.figure_filepath_lineEdit.setEnabled)  # type: ignore
        self.save_settings_chkbox.toggled['bool'].connect(
            self.seg_lbl.setEnabled)  # type: ignore
        self.save_settings_chkbox.toggled['bool'].connect(
            self.label_5.setEnabled)  # type: ignore
        self.save_settings_chkbox.toggled['bool'].connect(
            self.settings_filepath_lineEdit.setEnabled)  # type: ignore
        self.filepath_lineEdit.textChanged['QString'].connect(
            Dialog.on_update_filepaths)  # type: ignore
